import mass as m, numpy as n, os, pickle
...
class EvolutionMusic:
    ...
    def makeMusic(self,framerate=4.,renderVideo=True):
        ...
        sy2.setupEngine(self.samplerate,total_time,self.T)
        line2=self.sy2.sonicLine2(
   self.degrees_[-1],self.degrees_[-2])

        line4=self.sy2.sonicLine1(
  self.degrees_[0],[0,3,6,9],ambit=24,rythmic_pattern=[0,0,1,1],f0=440)
        line3=self.sy2.sonicLine1(
    self.degrees_[1],[0,4,8],ambit=24,rythmic_pattern=[1],f0=110)
